...
module.exports = {
  ...
  prompt: {
    ...
    types: [
      ...
      { value: 'refactor', name: 'refactor: 代码重构（不包括 bug 修复、功能新增）', emoji: ':recycle:' },
      { value: 'types', name: 'types:    类型修改', emoji: ':label:' },
      { value: 'docs', name: 'docs:     文档变更', emoji: ':pencil:' },
      { value: 'perf', name: 'perf:     性能优化', emoji: ':zap:' },
      { value: 'style', name: 'style:    代码格式（例如换行,分号）', emoji: ':art:' },
      { value: 'test', name: 'test:     添加、修改测试用例', emoji: ':white_check_mark:' },
      { value: 'build', name: 'build:    构建流程、外部依赖变更（如升级 npm 包、修改 webpack 配置等）', emoji: ':construction_worker:' },
      { value: 'ci', name: 'ci:       修改 CI 配置、脚本', emoji: ':wrench:' },
      { value: 'revert', name: 'revert:   回滚 commit', emoji: ':rewind:' },
      { value: 'wip', name: 'wip:      功能开发中', emoji: ':construction:' },
      { value: 'workflow', name: 'workflow: 工作流程变更', emoji: ':beers:' },
      { value: 'chore', name: 'chore:    对构建过程或辅助工具和库的更改（不影响源文件、测试用例）', emoji: ':robot:' },
    ],
    scopes: [
      { value: 'components', name: 'components:    组件相关' },
      { value: 'hooks', name: 'hooks:         组件相关' },
      { value: 'utils', name: 'utils:         utils 相关' },
      { value: 'component-ui', name: 'component-ui:    对 ui组件库 的调整' },
